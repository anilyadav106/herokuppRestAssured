...
public class ExtentManager {
	...
	public static ExtentReports createReport(String fileName) {
		...
		htmlReporter.config().setReportName("Test Report for RestAssured herokuapp Testing Framework designed by Anil");
      ...
      //attach the htmlreporter to this extent report
		...
		extent.setSystemInfo("Build no", "herokuapp-1234");
